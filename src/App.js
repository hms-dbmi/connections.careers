...
function App(props) {
  // Check which page a user is opening
  let curPage = props.location.pathname.replace('/connections.careers', '');
  const participantsPages = data.map((d, i) => `/${i + 1}`);
  const mainPages = ["/home", "/participants", "/about"];
  const allPages = [...mainPages, ...participantsPages];
  const selectedMenu =
    curPage && allPages.find((d) => d === curPage) ? curPage : allPages[0];

  // Concatenate the name and title of a participant
  const getNameTitle = (d) => d.name + (d.title ? `, ${d.title}` : "");

  console.log(curPage, props.location.pathname);
  // console.log(mainPages.indexOf(selectedMenu) !== -1);
  return (
    <div className="app">
      {/* --------------- Social Preview --------------- */}
      {
        mainPages.indexOf(selectedMenu) !== -1 ? (
          <Helmet>
            {/* <title>Connections</title> */}
            {/* <meta name="og:title" content="Connections"/>
            <meta name="twitter:title" content="Connections"/>
            <meta name="twitter:text:title" content="Connections"/>
            
            <meta name="description" content="Connections: Career Paths in Biomedical Informatics"/>
            <meta name="twitter:description" content="Connections: Career Paths in Biomedical Informatics"/> */}
            
            <meta name="twitter:card" content="summary_large_image"/>
            <meta property="og:image" content="https://github.com/hms-dbmi/connections.careers/blob/23e997dce45c01a94b3ca3a49dbc306bf11bc7f5/src/rsc/home-800px.png?raw=true"/>
            <meta name="twitter:image" content="https://github.com/hms-dbmi/connections.careers/blob/23e997dce45c01a94b3ca3a49dbc306bf11bc7f5/src/rsc/home-800px.png?raw=true"/>
            <link rel="apple-touch-icon" href="https://github.com/hms-dbmi/connections.careers/blob/23e997dce45c01a94b3ca3a49dbc306bf11bc7f5/src/rsc/home-800px.png?raw=true" />
          </Helmet>
        ) : (
          <Helmet>
            {/* <title>Connections</title> */}
            ...
            <meta name="twitter:card" content="summary_large_image"/>
            <meta property="og:image" content="https://github.com/hms-dbmi/connections.careers/blob/master/src/rsc/Alexandra%20Signoriello.jpg?raw=true"/>
            <meta name="twitter:image" content="https://github.com/hms-dbmi/connections.careers/blob/master/src/rsc/Alexandra%20Signoriello.jpg?raw=true"/>
            <link rel="apple-touch-icon" href="https://github.com/hms-dbmi/connections.careers/blob/master/src/rsc/Alexandra%20Signoriello.jpg?raw=true" />
          </Helmet>
        )
      }
        ...
        {selectedMenu === "/home" ? (
          <div className="home">
            ...
            <p className="home-text plain-text">
              ...
              <a href="https://www.nlm.nih.gov/ep/GrantTrainInstitute.html">
        ...
        {selectedMenu === "/about" ? (
          <div className="about">
            <p className="about-text plain-text">
              ...
              <a href="https://dbmi.hms.harvard.edu/education/nlm-biomedical-informatics-data-science-fellowship">
                Harvard Medical School Biomedical Informatics and Data Science
                Training program
              </a>
              , 3T15LM007092-26S1.
              <h2>Principal Investigators</h2>
              <a href="https://dbmi.hms.harvard.edu/people/nils-gehlenborg">
                Nils Gehlenborg, PhD
              </a>{" "}
              and{" "}
              <a href="https://dbmi.hms.harvard.edu/people/alexa-mccray">
                Alexa McCray, PhD
              </a>{" "}
