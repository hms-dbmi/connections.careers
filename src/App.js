  ...
  return (
    <div className="app">
      <div className="header">
        <span className="title" onClick={() => window.open(pkg.homepage, "_self")}>
          Connections&nbsp;
        </span>
      ...
      <div className="body">
        ...
        {selectedMenu === '/home' ?
          <div className="home">
            ...
            (placeholder) Trainees from across the 16 National of Library of Medicine (NLM) university-based Biomedical Informatics and Data Science Research Trainees programs will be featured in 16-part video series titled Connections: Career Paths in Biomedical Informatics. The 16 video testimonials capture the career paths of NLM training grant graduates. 
            <br/>
            <br/>
            The video project is funded by the National Library of Medicine Administrative Supplement Funds to the Harvard Medical School Biomedical Informatics and Data Science Training program, 3T15LM007092-26S1. The videos will be available under the CC-BY 4.0 license.
            </p>
          </div>
          : null
        }
        ...
        {/* --------------- PARTICIPANTS DETAIL --------------- */}
        {
          participantsPages.includes(curPage) ? (
            <div className="participant-detail">
              <div className='participant-detail-title'>{data[+curPage.split('/')[1] - 1].csTitle}</div>

              <div className="participant-detail-video">
              <iframe
                width="100%"
                height="100%"
                src={`https://www.youtube.com/embed/${data[+curPage.split('/')[1] - 1].csYt}`}
                title={data[+curPage.split('/')[1] - 1].csTitle} 
                frameBorder="0" 
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen/>
              </div>
              <div>
              <ReactMarkdown className="md" remarkPlugins={[gfm]} rehypePlugins={[rehypeRaw]} children={data[+curPage.split('/')[1] - 1].csBody}/>
              </div>
            </div>
          ): null
        }
      ...
      <div className="footer">
        © 2021 <a href="https://dbmi.hms.harvard.edu/" target="_blank">Department of Biomedical Informatics</a> / <a href="https://hms.harvard.edu/" target="_blank">Harvard Medical School</a>
      </div>
    </div>
  );
}
